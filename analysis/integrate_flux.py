...
#        energy = (ehigh+elow)/2.0
#        energy_SBND.append(float(row[0]))
...
#SBND_neutrino_vmu_integrated_flux = simpson(flux_SBND_neutrino_vmu, x=energy_SBND)  # Integrated flux [v / m^2 POT]
#SBND_neutrino_ve_integrated_flux = simpson(flux_SBND_neutrino_ve, x=energy_SBND)  # Integrated flux [v / m^2 POT]
#SBND_neutrino_vmubar_integrated_flux = simpson(flux_SBND_neutrino_vmubar, x=energy_SBND)  # Integrated flux [v / m^2 POT]
#SBND_neutrino_vebar_integrated_flux = simpson(flux_SBND_neutrino_vebar, x=energy_SBND)  # Integrated flux [v / m^2 POT]
