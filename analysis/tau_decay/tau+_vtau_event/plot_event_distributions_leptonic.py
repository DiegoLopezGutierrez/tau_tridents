...
nu_tau_p_33GeV, muon_p_33GeV, pMiss_p_33GeV, nucleon_p_33GeV = read_four_vectors_incoh(DIST_DIR_1TAU+'/nucleon/proton/tau+_vtau_events/tau_leptonic_decayed_distribution_p_33GeV.txt', 'proton')
nu_tau_n_33GeV, muon_n_33GeV, pMiss_n_33GeV, nucleon_n_33GeV = read_four_vectors_incoh(DIST_DIR_1TAU+'/nucleon/neutron/tau+_vtau_events/tau_leptonic_decayed_distribution_n_33GeV.txt', 'neutron')
nu_tau_Ar_47GeV, muon_Ar_47GeV, neutrinos_Ar_47GeV, pMiss_Ar_47GeV = read_four_vectors_coh(DIST_DIR_1TAU+'/coherent/argon/tau+_vtau_events/tau_leptonic_decayed_distribution_Ar_47GeV.txt')
...
ax61.text(0.15,0.90,r'\textbf{Bkg (DUNE)}',ha='left',transform=ax61.transAxes, fontsize=40, color=background_color)
...
ax62.text(0.78,0.77,r'\textbf{Signal}',ha='right',transform=ax62.transAxes, fontsize=40, color=signal_color)
ax62.text(0.78,0.72,r'\textbf{(This work)}',ha='right',transform=ax62.transAxes, fontsize=40, color=signal_color)
ax62.text(0.15,0.90,r'\textbf{Bkg (DUNE)}',ha='left',transform=ax62.transAxes, fontsize=40, color=background_color)
...
# Save #
fig1.savefig("../../../plots/ptMiss_1tau_leptonic_tau+_vtau_events.png", dpi=100, bbox_inches='tight')
fig2.savefig("../../../plots/ptMuon_1tau_leptonic_tau+_vtau_events.png", dpi=100, bbox_inches='tight')
#fig4.savefig("../plots/RMiss_1tau_leptonic_tau+_vtau_events.png", dpi=100, bbox_inches='tight')
fig5.savefig("../../../plots/ThetaMiss_1tau_leptonic_tau+_vtau_events.png", dpi=100, bbox_inches='tight')
fig6.savefig("../../../plots/RMiss_1tau_leptonic_tau+_vtau_events.png", dpi=100, bbox_inches='tight')
