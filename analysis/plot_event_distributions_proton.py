...
Fermi4Q2_1tau_nucleon_p_200GeV = []
...
def read_after_skip(file_path, E_v, skip_lines=37):
    with open(file_path, 'r') as txtfile:
        ...
        return pt_miss_array, pt_muon_array, pt_tau_array, r_miss_array, q2_array

ptMiss_1tau_nucleon_p_5GeV, ptMuon_1tau_nucleon_p_5GeV, ptTau_1tau_nucleon_p_5GeV, RMiss_1tau_nucleon_p_5GeV, Fermi4Q2_1tau_nucleon_p_5GeV = read_after_skip(EVENTS_DIR_1TAU+'/1tau_1e5Events_p_5GeV.txt', 5)
ptMiss_1tau_nucleon_p_10GeV, ptMuon_1tau_nucleon_p_10GeV, ptTau_1tau_nucleon_p_10GeV, RMiss_1tau_nucleon_p_10GeV, Fermi4Q2_1tau_nucleon_p_10GeV = read_after_skip(EVENTS_DIR_1TAU+'/1tau_1e5Events_p_10GeV.txt', 10)
ptMiss_1tau_nucleon_p_20GeV, ptMuon_1tau_nucleon_p_20GeV, ptTau_1tau_nucleon_p_20GeV, RMiss_1tau_nucleon_p_20GeV, Fermi4Q2_1tau_nucleon_p_20GeV = read_after_skip(EVENTS_DIR_1TAU+'/1tau_1e5Events_p_20GeV.txt', 20)
ptMiss_1tau_nucleon_p_50GeV, ptMuon_1tau_nucleon_p_50GeV, ptTau_1tau_nucleon_p_50GeV, RMiss_1tau_nucleon_p_50GeV, Fermi4Q2_1tau_nucleon_p_50GeV = read_after_skip(EVENTS_DIR_1TAU+'/1tau_1e5Events_p_50GeV.txt', 50)
ptMiss_1tau_nucleon_p_200GeV, ptMuon_1tau_nucleon_p_200GeV, ptTau_1tau_nucleon_p_200GeV, RMiss_1tau_nucleon_p_200GeV, Fermi4Q2_1tau_nucleon_p_200GeV = read_after_skip(EVENTS_DIR_1TAU+'/1tau_1e5Events_p_200GeV.txt', 200)
...
if vertical_flag:
    ...
    fig5, (ax51, ax52, ax53, ax54, ax55) = plt.subplots(1, 5, sharey=True, figsize=(60,15), tight_layout=True) # Fermi4Q2
    ...
    ### Fermi4Q2 ###
    ax51.hist(Fermi4Q2_1tau_nucleon_p_5GeV, density=False, bins=Fermi4Q2_1tau_nucleon_p_10GeV_bins, weights=wts_Fermi4Q2_1tau_nucleon_p_10GeV, color='royalblue', alpha=0.3, edgecolor='black', lw=0.5)
    ax51.hist(Fermi4Q2_1tau_nucleon_p_5GeV, density=False, bins=Fermi4Q2_1tau_nucleon_p_10GeV_bins, weights=wts_Fermi4Q2_1tau_nucleon_p_10GeV, histtype='step', color='black', alpha=1, lw=2)
    ...
    for ax in [ax11, ax21, ax31, ax41, ax51]:
        ax.text(0.90,0.90,r'\textbf{5 GeV}',ha='right',transform=ax.transAxes, fontsize=30)

    for ax in [ax12, ax22, ax32, ax42, ax52]:
        ax.text(0.90,0.90,r'\textbf{10 GeV}',ha='right',transform=ax.transAxes, fontsize=30)

    for ax in [ax13, ax23, ax33, ax43, ax53]:
        ax.text(0.90,0.90,r'\textbf{20 GeV}',ha='right',transform=ax.transAxes, fontsize=30)

    for ax in [ax14, ax24, ax34, ax44, ax54]:
        ax.text(0.90,0.90,r'\textbf{50 GeV}',ha='right',transform=ax.transAxes, fontsize=30)

    for ax in [ax15, ax25, ax35, ax45, ax55]:
        ax.text(0.90,0.90,r'\textbf{200 GeV}',ha='right',transform=ax.transAxes, fontsize=30)
