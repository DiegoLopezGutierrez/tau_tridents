...
print("Calculating DUNE normalized histogram with total integrated flux of ", DUNE_integrated_flux)
flux_DUNE_norm = np.divide(flux_DUNE, DUNE_integrated_flux)

with open('DUNE_hist_normalized.csv','w',newline='') as csvfile:
    ...
    for i, b in enumerate(bin_edges):
        ...
        flux_bin = 0
        for energy, flux in zip(energy_DUNE, flux_DUNE_norm):
